...
function GetStarted() {
  ...
  return (
    <div className="flex flex-col lg:flex-row  h-screen justify-center items-center">
      <div className="lg:w-1/2 text-center mt-[10vw] sm:mt-10 md:mt-0 pt-10 ">
        <h1 className="text-3xl sm:text-4xl md:text-7xl font-bold text-primary-color font-freeman">
